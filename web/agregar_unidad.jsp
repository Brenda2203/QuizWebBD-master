    ...
    <body>
        ...
        <div class="row tm-section">
            ...
            <section class="tm-section-contact">
                ...
                <form align="center" action="UnidadSer" method="post" class="tm-contact-form">                                
                        ...
                        <select name="id_contexto" class="form-control form-control-lg">
                            <%
                                if (request.getAttribute("respuesta1") != null) {
                                    ArrayList<ContextoNavegacion> array = (ArrayList<ContextoNavegacion>) request.getAttribute("respuesta1");
                                    System.out.println(array.toString());
                                    for (ContextoNavegacion contexto : array) {     
                            %>
